...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  if ($result && mysqli_num_rows($result) > 0) {
    ...
    if (password_verify($password, $user['password_user'])) {
      ...
      // Notifikasi dan arahkan berdasarkan role
      if ($user['role'] == 'admin') {
        $success = "✅ Login berhasil sebagai <b>Admin</b>! Mengarahkan ke dashboard admin...";
        echo "
          <script>
            setTimeout(function() {
        ...
        <div class="col-md-6 d-flex flex-column justify-content-center p-4">
          ...
          <form action="" method="POST">
            <div class="input-group mb-3">
              ...
              <input type="text" name="username" class="form-control border-start-0" placeholder="Email atau Username" required>
            </div>
