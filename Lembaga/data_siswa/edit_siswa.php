...
<head>
  ...
  <title>Dashboard | Edit Data Siswa</title>
...
<body>
  ...
  <!-- MAIN CONTENT -->
  <main class="content">
    <h2><i class="fas fa-pen-to-square"></i> Edit Data Siswa</h2>

    <div class="form-card">
      <form method="post">
        <label>Absen:</label>
        <input type="number" name="absen" value="" required>
        ...
        <input type="text" name="wali_kelas" value="" required>
