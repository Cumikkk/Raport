      ...
      <div class="col-12">
        <div class="card shadow-sm" style="border-radius: 15px;">
          <div class="mt-0 d-flex align-items-center flex-wrap mb-0 p-3">
            <!-- Judul di kiri -->
            <h5 class="mb-1 fw-semibold fs-4">Data Mata Pelajaran</h5>

            <!-- Tombol di kanan -->
            <div class="ms-auto d-flex gap-2">
              <a href="data_mapel_tambah.php" class="btn btn-primary btn-sm d-flex align-items-center gap-1 p-2 pe-3 fw-semibold" style="border-radius: 5px;">
