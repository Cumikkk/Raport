...
<body>
    ...
    <body>
        ...
        <!-- MAIN CONTENT -->
        <main class="content ">
            <section class="cards" style="margin-top:-50px; margin-left:250px;">
                <div class="row g-3">
                        ...
                        <div class="card shadow-sm h-100">
                            <div class="card-body">
                                ...
                                <form>
                                    <!-- Nama Mapel -->
                                    <div class="mb-3">
                                        <label for="namaMapel" class="form-label">Nama Guru</label>
                                        <input type="text" class="form-control" id="namaMapel" placeholder="Masukkan nama mapel">
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="jenis">
                                            <option selected>Honorer</option>
