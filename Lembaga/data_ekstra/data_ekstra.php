      ...
      <div class="col-12">
        <div class="card shadow-sm" style="border-radius: 15px;">
          <div class="mt-0 d-flex align-items-center flex-wrap mb-0 p-3">
            <!-- Judul di kiri -->
            <h5 class="mb-1 fw-semibold fs-4">Data Ekstrakulikuler</h5>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-center">
                      ...
                      <a href="hapus_ekstra.php?id=1" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?');">
