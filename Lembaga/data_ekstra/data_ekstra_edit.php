            ...
            <div class="col-12">
                ...
                <div class="card shadow-sm" style="border-radius: 15px;">
                    <div class="mt-0 d-flex align-items-center flex-wrap mb-0 p-3">
                        <!-- Judul di kiri -->
                        <h5 class="mb-1 fw-semibold fs-4">Edit Data Ekstrakulikuler</h5>
                    </div>

                    <!-- Tabel Edit Data Ekstra -->
                    <div class="card-body">
                        <form>
                            <!-- Nama Ekstra -->
                            <div class="mb-3">
                                <label for="namaMapel" class="form-label">Nama Ekstrakulikuler</label>
                                <input type="text" class="form-control" id="namaMapel" placeholder="Masukkan nama ekstra" value="Catur">
                            </div>
