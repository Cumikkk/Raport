              ...
              <table class="table table-bordered table-striped align-middle">
                ...
                <tbody class="text-center">
                  <tr>
                    ...
                    <td>0</td>
                    <td>
                      <a href="data_absensi_edit.php?id=1" class="btn btn-warning btn-sm d-inline-flex align-items-center gap-1 px-2 py-1">
                  ...
                  <tr>
                    ...
                    <td>1</td>
                    <td>
                      <a href="data_absensi_edit.php?id=2" class="btn btn-warning btn-sm d-inline-flex align-items-center gap-1 px-2 py-1">
                        <i class="bi bi-pencil-square"></i>Edit
                      </a>
